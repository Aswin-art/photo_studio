...
export default function Home() {
  ...
  if (!mounted) return <div className="h-[358px] w-full justify-items-center content-center justify-center align-middle flex gap-x-4"><Loader2 className="animate-spin self-center" size={20} /><p className="self-center">Loading ....</p></div>;
