...
export default function BookingPayment() {
    ...
    const bookingTime = convertBookingSession(Number(cookieUtils.get('bookingTime')));
    const message = encodeURIComponent(`Halo Admin, saya ingin mengonfirmasi pembayaran booking studio. Berikut detailnya:
        - Nama: ${name}
        - Email: ${email}
        - Nomor Telepon: ${phone}
    ...
    useEffect(() => {
        ...
        }else if(!cookieUtils.get('name') || !cookieUtils.get('email') || !cookieUtils.get('phone') || !cookieUtils.get('totalPrice')){
