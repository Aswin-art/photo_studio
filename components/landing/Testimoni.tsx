    ...
    const testimonials = [
        {
          ...
          src: "/pictures/testimonials/photo-2.jpg",
        },
        {
          quote:
          ...
          src: "/pictures/testimonials/photo-8.jpg",
        },
        {
          quote:
          ...
          src: "/pictures/testimonials/photo-3.jpg",
        },
        {
          quote:
          ...
          src: "/pictures/testimonials/photo-5.jpg",
        },
        {
          quote:
          ...
          src: "/pictures/testimonials/photo-6.jpg",
        },
        {
          quote:
          ...
          src: "/pictures/testimonials/photo-4.jpg",
        },
        {
          quote:
          ...
          src: "/pictures/testimonials/photo-14.jpg",
        },
        {
          quote:
          ...
          src: "/pictures/testimonials/photo-15.jpg",
        }
      ];
            ...
            <section className="flex flex-col items-center py-10 lg:py-20">
                <div className="space-y-7 text-center">
                    <div className="space-y-4">
                        ...
                        <p className="text-muted-foreground">Real stories from our happy clients</p>
                    </div>
                </div>
