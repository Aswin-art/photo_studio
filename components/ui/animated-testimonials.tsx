...
export const AnimatedTestimonials = ({
  ...
  // Generate consistent random rotation values only once
            ...
            {testimonials.map((testimonial, index) => (
              <motion.div
                ...
                initial={{
                  opacity: 0,
                  scale: 0.9,
                  transform: `translateZ(-100px) scale(0.9) rotate(${randomRotations[index]}deg)`,
                }}
                animate={{
                  ...
                  transform: active === index
                    ...
                    : `translateZ(-100px) scale(0.9) rotate(${randomRotations[index]}deg)`,
                  zIndex: active === index ? 10 : testimonials.length + 2 - index,
